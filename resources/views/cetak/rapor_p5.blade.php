...
<table>
	<tr>
		...
		<td style="width: 30%" class="text-right">
			<img src="{{($get_siswa->rombongan_belajar->sekolah && $get_siswa->rombongan_belajar->sekolah->logo_sekolah) ? asset('storage/images/'.$get_siswa->rombongan_belajar->sekolah->logo_sekolah) : asset('images/tutwuri.png')}}" height="75" />
		</td>
	</tr>
</table>
<br>
