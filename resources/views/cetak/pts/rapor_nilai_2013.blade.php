...
$data['mapel_a'] = $this->pembelajaran->with('mata_pelajaran')->find_all("semester_id =  $ajaran_id AND  rombongan_belajar_id = '$rombongan_belajar_id' AND guru_id IS NOT NULL AND kelompok_id = 1", '*','no_urut ASC');
...
$data['mapel_b'] = $this->pembelajaran->with('mata_pelajaran')->find_all("semester_id =  $ajaran_id AND  rombongan_belajar_id = '$rombongan_belajar_id' AND guru_id IS NOT NULL AND kelompok_id = 2", '*','no_urut ASC');
$data['mapel_c1'] = $this->pembelajaran->with('mata_pelajaran')->find_all("semester_id =  $ajaran_id AND  rombongan_belajar_id = '$rombongan_belajar_id' AND guru_id IS NOT NULL AND kelompok_id = 3", '*','no_urut ASC');
$data['mapel_c2'] = $this->pembelajaran->with('mata_pelajaran')->find_all("semester_id =  $ajaran_id AND  rombongan_belajar_id = '$rombongan_belajar_id' AND guru_id IS NOT NULL AND kelompok_id = 4", '*','no_urut ASC');
$data['mapel_c3'] = $this->pembelajaran->with('mata_pelajaran')->find_all("semester_id =  $ajaran_id AND  rombongan_belajar_id = '$rombongan_belajar_id' AND guru_id IS NOT NULL AND kelompok_id = 5", '*','no_urut ASC');
...
<table <?php echo $border; ?> class="<?php echo $class; ?>">
  ...
  <tr>
    ...
    <tbody>
		<?php
		$data['rencana_penilaian_id'] = $rencana_penilaian_id;
