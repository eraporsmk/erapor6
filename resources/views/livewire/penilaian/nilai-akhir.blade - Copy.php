                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea wire:ignore wire:model="deskripsi_dicapai.{{$siswa->anggota_rombel->anggota_rombel_id}}" class="form-control"></textarea>
                                        </td>
                                        <td>
                                            <textarea wire:ignore wire:model="deskripsi_belum_dicapai.{{$siswa->anggota_rombel->anggota_rombel_id}}" class="form-control"></textarea>
                                        </td>
                                    </tr>
                                    @endforeach      
                                </tbody>
