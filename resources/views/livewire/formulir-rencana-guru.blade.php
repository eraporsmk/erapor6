<div>
    ...
    <div class="row mb-2" wire:ignore>
        ...
        <div class="col-sm-9">
            <select id="rencana_penilaian_id" class="form-select" wire:model="rencana_penilaian_id" data-pharaonic="select2" data-component-id="{{ $this->id }}" data-placeholder="== Pilih Rencana Penilaian ==">
