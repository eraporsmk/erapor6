                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Jumlah PD</th>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center align-middle" colspan="2">Jumlah Rencana Penilaian</th>
                            <th class="text-center align-middle" colspan="2">Generate Nilai</th>
                        </tr>
                        <tr>
                            <th class="text-center align-middle">Pengetahuan</th>
                            <th class="text-center align-middle">Keterampilan</th>
                            <th class="text-center align-middle">Pengetahuan</th>
                            <th class="text-center align-middle">Keterampilan</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @forelse ($rombongan_belajar->pembelajaran as $item)
                            <tr>
                                ...
                                <td>{{$item->nama_mata_pelajaran}}</td>
                                <td>{{($item->pengajar) ? $item->pengajar->nama_lengkap : $item->guru->nama_lengkap}}</td>
                                <td class="text-center">{{$item->skm}}</td>
