        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="fw-bolder">{{$sekolah->rencana_pengetahuan_count}}</h2>
                    <p class="card-text">Rencana Pengetahuan</p>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="fw-bolder">{{$sekolah->rencana_keterampilan_count}}</h2>
                    <p class="card-text">Rencana Keterampilan</p>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="fw-bolder">{{$sekolah->nilai_pengetahuan_count}}</h2>
                    <p class="card-text">Nilai Pengetahuan</p>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="fw-bolder">{{$sekolah->nilai_keterampilan_count}}</h2>
                    <p class="card-text">Nilai Keterampilan</p>
                </div>
            </div>
        </div>
    </div>
