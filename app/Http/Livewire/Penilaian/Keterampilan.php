...
class Keterampilan extends Component
{
    ...
    {
        $breadcrumbs = [
            ['link' => "/", 'name' => "Beranda"], ['link' => '#', 'name' => 'Penilaian'], ['name' => "Keterampilan"]
        ];
        if(!status_penilaian()){
        ...
        return view('livewire.penilaian.keterampilan', [
            'breadcrumbs' => $breadcrumbs
        ]);
    }
    ...
    public function store(){
        ...
        $this->flash('success', 'Nilai berhasil disimpan', [], '/penilaian/keterampilan');
    }
